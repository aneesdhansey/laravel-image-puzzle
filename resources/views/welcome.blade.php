...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    <head>
        ...
        <title>Laravel Image Puzzle</title>
    ...
    <body>
        ...
        @isset($images)
            <div class="puzzle-area">
                ...
                <h4 id="msgWin" style="display: none; color: green; font-weight: bold;">You Won!!!</h4>
                <div id="puzzle">
                    @foreach($images as $img)
                        <img class="puzzle-piece" src="{{ asset($img['image_url']) }}" data-part-no="{{$img['part_no']}}" style="width: 100%;height: 100%"/>
                    @endforeach
                </div>
            </div>
        @endisset
